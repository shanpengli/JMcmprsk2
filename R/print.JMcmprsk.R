##' Print contents of JMcmprsk2 object.
##'
##'
##' @title Print JMcmprsk2
##' @param x Object of class 'JMcmprsk2'.
##' @param ... Further arguments passed to or from other methods.
##' @seealso \code{\link{jmc}}
##' @author Hong Wang
##' @export
print.JMcmprsk2 <- function(x, ...) {
  if (!inherits(x, "JMcmprsk2"))
    stop("Not a legitimate \"JMcmprsk2\" object")
