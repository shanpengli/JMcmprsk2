...
##' @return Object of class \code{JMcmprsk22} with elements
##'   \tabular{ll}{
...
##' require(JMcmprsk2)
##' set.seed(123)
##' yfile=system.file("extdata", "jmcsimy.txt", package = "JMcmprsk2")
##' cfile=system.file("extdata", "jmcsimc.txt", package = "JMcmprsk2")
##' mfile=system.file("extdata", "jmcsimm.txt", package = "JMcmprsk2")
...
##' require(JMcmprsk2)
##' set.seed(123)
##' yfile=system.file("extdata", "fvc621_y.txt", package = "JMcmprsk2")
##' cfile=system.file("extdata", "fvc621_c.txt", package = "JMcmprsk2")
##' mfile=system.file("extdata", "fvc621_m.txt", package = "JMcmprsk2")
